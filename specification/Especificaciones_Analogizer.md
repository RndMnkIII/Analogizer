...
* Alumentación externa de 5V utilizando puerto USB3 C. Necesaria para alimentacion de adaptador activo Y/C, activación de modo RGB en TV con SCART y slimentación de mandos de juegos nativos.
